...
<figure><img src=".gitbook/assets/cli.JPG" alt=""><figcaption></figcaption></figure>**Chloros CLI** предоставя мощен достъп чрез командния ред до двигателя за обработка на изображения Chloros, което позволява автоматизация, скриптове и работа без монитор за вашите работни процеси за обработка на изображения.
...
2. Изпълнете инсталационния магьосник
...
| `--ppk`               | Флаг    | Деактивирано       | Приложи PPK корекции от .daq данни от сензора за светлина                                      |
...
**О:** Да! CLI работи напълно без GUI. Изисквания:
