...
| `poll_interval`     | float    | `2.0`        | Интервал на проверка за напредъка (секунди)   |
...
3. Опитайте ръчно да зададете пътя към бекенда:
...
**О:** Само за първоначална активация на лиценза. След влизане чрез Chloros, Chloros (браузър) или Chloros CLI лицензът се запаметява локално и работи офлайн в продължение на 30 дни.
...
**О:** Да! Използвайте Windows Task Scheduler с Python скриптове:
