...
2. Въведете вашите Chloros+ идентификационни данни и влезте
3. Лицензът се запазва локално (остава и след рестартиране)
...
| ------------------------- | ---- | ------------------------- | ------------------------------------- |
| `api_url`                 | str  | `"http://localhost:5000"` | URL на локален Chloros бекенд          |
...
| `indices`                 | list | `None`                  | Растителни индекси за изчисление |
...
| Параметър           | Тип     | По подразбиране      | Описание                               |
| ------------------- | -------- | ------------ | ----------------------------------------- |
| `mode`              | str      | `"parallel"` | Режим на обработка: „паралелен“ или „сериен“   |
...
## Поддръжка на контекстни мениджъри
...
**О:** Само за първоначална активация на лиценза. След влизане чрез Chloros, Chloros (браузър) или Chloros CLI лицензът се кешира локално и работи офлайн в продължение на 30 дни.
