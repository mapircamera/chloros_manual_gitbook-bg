...
3. **Активен Chloros+ лиценз** ([ъпгрейд](https://cloud.mapir.camera/pricing))
...
1. Отворете **Chloros или Chloros (браузър)** и влезте в профила си в раздела „Потребител“ <img src=".gitbook/assets/icon_user.JPG" alt="" data-size="line"> . Или отворете **CLI**.
2. Въведете вашите Chloros+ данни за достъп и влезте
3. Лицензът се съхранява локално (запазва се при рестартиране)
...
{% hint style=&quot;warning&quot; %}
**Паралелен режим**: Изисква Chloros+ лиценз. Автоматично се мащабира според ядрата на вашия процесор (до 16 работни процеса).
{% endhint %}
...
* Лиценз, активиран на която и да е машина (кеширана лицензия, копирана на сървъра)
