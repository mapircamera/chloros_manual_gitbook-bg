...
* [ ] **Импортирани файлове** – Всички изображения се показват в браузъра за файлове
...
* [ ] **Форматът за експортиране е избран** - Изходният формат е подходящ за вашия работен процес
...
4. Лентата за напредъка се актуализира, показвайки статуса на обработката
...
2. **Анализиране** - Проверка на метаданните на изображенията и подготовка на тръбопровода
...
* **Наведете мишката** върху индикатора, за да видите подробен панел с 4 етапа
* **Кликнете** върху индикатора за напредък, за да замразите панела на място
* **Кликнете отново**, за да размразите и скриете панела
...
* Идентифицира 4 калибрационни панела във всяка цел
...
* Запазва максимално качеството и детайлите на изображението

**Продължителност:** Варира в зависимост от броя изображения и скоростта на процесора
...
* Прилага лентова математика към калибрираните изображения
...
**Продължителност:** Варира в зависимост от формата на експортиране и размера на файла
...
* Актуализациите на напредъка се показват в реално време

### Използване на компютъра по време на обработката

**Свободен режим:**

* Сравнително ниско използване на процесора (еднонишково)
...
* Висока употреба на процесора (многонишкова, до 16 ядра)
* С GPU ускорение: Висока употреба на GPU
* Компютърът може да бъде по-малко отзивчив по време на обработката
* Избягвайте да стартирате други задачи, изискващи интензивна употреба на процесора
...
### Обработката не може да бъде преустановена
...
* **Видите текущия етап** – откриване, анализ, калибриране или експортиране
* **Проверете раздела с логове** – вижте подробни съобщения и предупреждения за обработката
* **Прегледате завършените изображения** – някои експортирани файлове могат да се появят по време на обработката
...
* Прегледайте и отстранете всички проблеми
...
* Наличност на графичен процесор (само Chloros+)
...
### Бутонът „Старт“ е деактивиран (посивен)
