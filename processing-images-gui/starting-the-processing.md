...
2. **Обработка** – прилагане на калибриране и експортиране на изображения.**Време за обработка:**

* Много по-бавно от Chloros+ паралелен режим
* Подходящо за малки до средни набори от данни (&lt; 200 изображения)
...
* Многонишкова операция (до 16 паралелни работници)
...
4. **Експортиране** - Запазване на обработените изображения и индекси**Взаимодействие с индикатора за напредък:*** **Наведете мишката** върху индикатора, за да видите подробен панел с 4 етапа
* **Кликнете** върху индикатора за напредък, за да замразите панела на място
* **Кликнете отново**, за да размразите и скриете панела**Време за обработка:**
...
**Какво прави Chloros:*** **Корекция на винет**: Премахва затъмняването на обектива по краищата
...
* След като започне, обработката не може да бъде прекъсната.
