...
{% hint style=&quot;success&quot; %}
**Подобрение на скоростта**: Маркирането на 2-3 целеви изображения в набор от данни с 500 изображения може да намали времето за откриване на целите от над 30 минути до по-малко от 1 минута.
{% endhint %}
...
* [ ] Отметнати са отметните полета в колоната „Цели“ за всички изображения на цели
