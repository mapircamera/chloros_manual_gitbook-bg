...
{% hint style=&quot;success&quot; %}
**Повишаване на скоростта**: Маркирането на 2-3 целеви изображения в набор от данни от 500 изображения може да намали времето за откриване на целите от над 30 минути до по-малко от 1 минута.
{% endhint %}
...
Ако Chloros не открива правилно вашите цели, настройте тези параметри в [Настройки на проекта](adjusting-project-settings.md):
...
4. Настройте настройките за откриване на цели, ако е необходимо
...
4. Уверете се, че изображенията на целите показват само целта (минимално затрупване на фона)
