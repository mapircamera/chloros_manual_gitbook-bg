...
{% hint style="info" %}
**Поддържани типове файлове**: Chloros поддържа RAW+JPG и JPG изображения от MAPIR Survey3W и Survey3N камери. Препоръчват се само RAW+JPG.
{% endhint %}
...
* Маркирайте тази опция за изображения, които съдържат калибрационни цели
* Значително ускорява откриването на целите по време на обработката
* Вижте [Избор на целеви изображения](choosing-target-images.md) за подробности

### Преглед на метаданни на изображения

Кликването върху бутона в горния десен ъгъл над таблицата показва метаданните на избраното изображение в областта на решетката с изображения.
...
* **Сортиране по времева марка**: Полезно за организиране на хронологични последователности от снимки.
...
* Съхранявайте калибрационните целеви изображения в същата папка като изображенията от проучването
...
### Калибрационни целеви изображения

* Винаги включвайте 1-2 калибрационни целеви изображения на сесия.
...
* Маркирайте целевите изображения, като използвате отметката „Цел“, за да ускорите обработката.
...
* Повреден файл или непълно прехвърляне от SD картата
...
2. **Проверете моделите на камерите** – Уверете се, че камерите са разпознати правилно
