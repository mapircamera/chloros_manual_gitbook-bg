...
2. Намерете папката, съдържаща вашите изображения.
...
* Отбележете тази отметка за изображения, които съдържат калибрационни цели
...
## Управление на файлове във вашия проект
