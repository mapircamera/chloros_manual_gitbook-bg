...
За потребители без лиценз Chloros+:

**Показване на напредъка в 2 етапа:**

1. **Откриване на целеви обекти** – Намиране на калибрационни целеви обекти в изображенията
...
* **Наведете курсора** върху индикатора за напредък, за да видите разширения 4-етапен панел
...
* Обработка на всяка снимка през цялата верига
...
* **GPU ускорение**: Значително ускорява този етап
...
| „Не са открити цели”               | Не са открити калибрационни цели        | Маркирайте целевите изображения или деактивирайте калибрирането на отражателната способност |
...
* Употребата на VRAM се увеличава (изисква 4GB+ VRAM)
...
2. Преместете проекта на устройство с повече пространство
