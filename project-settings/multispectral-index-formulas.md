...
_Източник: Huete, A., et al. „Общ преглед на радиометричните и биофизичните характеристики на индексите за растителност MODIS“. Дистанционно наблюдение на околната среда 83 (2002):195–213._
...
Този индекс е подобрение на нелинейния индекс (NLI), който включва индекса на растителността, коригиран спрямо почвата (SAVI), за да отчете почвения фон. ENVI използва стойност 0,5 за коефициента на коригиране на фоновата растителност (_L_).

$$
MNLI = {(NIR^{2} - Red) * (1 + L) \over (NIR^{2} + Red + L)  }
$$

_Източник: Yang, Z., P. Willis и R. Mueller. „Въздействие на изображението AWIFS с подобрено съотношение на честотните ленти върху точността на класифицирането на културите“. Доклади от симпозиума Pecora 17 Remote Sensing Symposium (2008), Денвър, Колорадо._
...
_Източник: Qi, J., A. Chehbouni, A. Huete, Y. Kerr и S. Sorooshian. „Модифициран индекс на растителността, коригиран според почвата“. Дистанционно наблюдение на околната среда 48 (1994): 119-126._
