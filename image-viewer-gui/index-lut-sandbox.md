...
Достъпът до Index/LUT Sandbox се осъществява в **Image Viewer** <img src="../.gitbook/assets/icon_image-viewer.JPG" alt="" data-size="line"> страничната лента:
...
* **2-5 класа**: Много широки категории, ясно разграничени зони
...
5. Повторете за полето **Максимална стойност** (например `0.9`)
...
* **Пример**: Вижте действителния вид на полето/реколтата с наслагване на цветово кодирани стресирани области
...
* **Редактиране на цветове** → Персонализираният градиент се прилага незабавно

**Няма нужда от бутон „Приложи“** – всички промени са в реално време и интерактивни!

{% hint style=&quot;success&quot; %}
**Обратна връзка в реално време**: Незабавната визуална обратна връзка ви позволява бързо да експериментирате с различни настройки, докато намерите оптималната визуализация за вашите нужди за анализ.
{% endhint %}
...
3. **Приложете градиент на LUT** - Започнете с предварителната настройка Red-Yellow-Green
4. **Проверете стойностите на пикселите** - Преместете курсора, отбележете диапазоните на стойностите
5. **Настройте мин./макс. - Стеснете, за да се фокусирате върху растителността (например от 0,2 до 0,9)
...
Разбирането на действителните стойности на пикселите е от решаващо значение за настройването на ефективни LUT диапазони:
...
4. **Дефинирайте формулата**, като използвате променливи на лентата:
...
{% hint style=&quot;warning&quot; %}
**Проверка на формулата**: Уверете се, че формулата ви използва ленти, които са налични във вашата камера. Например, RedEdge е налична само на камери с филтър RedEdge.
{% endhint %}
...
* **Групова обработка**: Приложете оптимизирани индекси към пълни набори от данни
