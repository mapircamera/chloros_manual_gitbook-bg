...
Достъп до Index/LUT Sandbox се получава от **Image Viewer** <img src="../.gitbook/assets/icon_image-viewer.JPG" alt="" data-size="line"> страничната лента:
...
* **20+ класа**: Почти непрекъснат, максимална гладкост
...
* **По-малко класове** (3-5): Създава отчетливи зони, опростена класификация, по-лесно разграничаване на категориите
...
### Фина настройка на диапазоните на стойности
...
* **Персонализиран диапазон**: Настройка въз основа на наблюдаваните стойности на пикселите

**Защо да настройвате диапазоните?**

* **Увеличаване на контраста** в областта, която ви интересува
...
* **Пример**: Стойностите NDVI под 0,2 се показват в червено, а стойностите над 0,9 се показват в зелено
...
{% hint style=&quot;warning&quot; %}
**Ограничение на прозрачността**: Прозрачните пиксели ще се появяват като цвят на фона в прозореца за преглед. При експортиране по време на обработката прозрачността се запазва във формат PNG, но не и в JPG.
{% endhint %}

#### 3. Индекс на фона

* Пикселите **извън обхвата** се показват в **сиво** (показват сурови индексни стойности)
* Пикселите **в рамките на диапазона** показват **цветови градиент**
* **Пример за употреба**: Деликатно подчертаване, запазване на контекста при акцентиране на области от интерес
...
6. **Изберете изрязване** – опитайте „Original Background“ (Оригинален фон) за контекста
