...
Достъпът до пясъчника за индекс/LUT се осъществява в **програмата за преглед на изображения** <img src="../.gitbook/assets/icon_image-viewer.JPG" alt="" data-size="line"> страничната лента:
...
* **Изход**: Цвят RGB (например яркозелено)
...
**Контролът „Класове“** определя колко дискретни цветови стъпки се появяват в градиента:
...
3. Премахнете броя на класовете, като кликнете два пъти върху цветен образец.
...
* **Стандартизирайте визуализацията** за няколко изображения или дати.
...
* Пикселите **в обхвата** се показват като **цветови градиент**
...
| **Оригинален фон**    | Отчети, презентации, интуитивен анализ | Цвят върху диапазона, снимка извън него |
...
* **Обръщане на градиента**: Обърнете реда на цветовете, за да обърнете значението (например зелено = ниско, червено = високо)
...
* **Оптимизиране на печата**: Изберете цветове, които работят както при цветен, така и при черно-бял печат
* **Многопрагов**: Използвайте различни цветове при определени прагови стойности за класификация
...
**Не е необходим бутон „Приложи“** – всички промени са в реално време и интерактивни!
...
След като проверите стойностите на пикселите, коригирайте съответно минималната/максималната стойност на LUT:
...
* **Изрязване**: „Оригинален фон“, за да видите почвата в естествения й цвят
...
{% hint style=&quot;warning&quot; %}
**Валидиране на формулата**: Уверете се, че формулата ви използва ленти, които са налични във вашата камера. Например, RedEdge е наличен само в камери с филтър RedEdge.
{% endhint %}
