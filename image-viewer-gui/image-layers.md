...
* Бърз преглед на оригиналното заснемане
...
* Сравнение на резултатите преди и след обработката
...
* Калибрирано изображение на отражателната способност
* Коригирана винетка (ако е активирана при обработката)
* Отражателна способност, калибрирана с помощта на целеви данни (ако е активирана)
* Многолентов TIFF с всички канали на камерата
* Стойностите на пикселите представляват процент на отражателната способност (при използване на процентен режим)
...
{% hint style=&quot;success&quot; %}
**Препоръчително**: Използвайте слой RAW (отражателност) при проверка на стойностите на пикселите за научни измервания и анализи.
{% endhint %}
...
3. Изображение 2 автоматично показва слой RAW (NDVI Index)
...
6. Превключете на **RAW (NDRE индекс)**, за да сравните
...
2. Изберете **RAW (Цел)** от падащото меню
...
* **Употреба**: Научни измервания и анализ

**За 16-битов TIFF:** Разделете на 65 535, за да получите процент на отражателност **За 32-битов процент:** Стойностите директно представляват процент (0,5 = 50% отражателност)
...
**Проблем**: RAW (целеви) слой не показва откриване на цели.
...
* [**Мултиспектрални индексни формули**](../project-settings/multispectral-index-formulas.md) – Налични индекси за справка
