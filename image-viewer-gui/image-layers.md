...
{% hint style=&quot;success&quot; %}
**Препоръчително**: Използвайте RAW (отражателност) при проверка на стойностите на пикселите за научни измервания и анализ.
{% endhint %}

### RAW (NDVI индекс)... и подобни
...
* Примери: RAW (NDVI индекс), RAW (NDRE индекс), RAW (GNDVI индекс) и др.
...
* **Последователни работни процеси**: Изберете един слой (например NDVI) и прегледайте целия набор от данни, преди да преминете към друг
...
* **Индексни слоеве**: Скорост, подобна на тази на слоевете „Отражателност“
...
* **Сравнявайте слоеве**: Използвайте превключването на слоеве, за да проверите дали обработката е работила правилно
...
2. Уверете се, че изображението всъщност съдържа видими калибрационни цели
...
* **Стрелки за навигация**: Премествайте се между изображенията, като запазвате слоя
...
Сега, след като разбрахте слоевете на изображенията:
