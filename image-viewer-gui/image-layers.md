...
* Използва се за проверка дали откриването на целта е успешно
...
* Стойностите на пикселите представляват процент на отражателност (при използване на процентен режим)
...
* **Бързи сравнения**: Превключвайте между „Оригинал“ и „Отражение“, за да проверите качеството на обработката
...
* Целите не са открити по време на обработката
...
* **Режим процент на пикселите**: Превключвайте между DN и процентно показване
